<template>
    <div class="col-md-8" style="float:left;" v-if = "isLoaded">    
        ...
        <hr/>
        <!-- Preview Image -->
        <!-- <img class="img-fluid rounded" src="https://cimgr.clozette.co.id/indo/f_jpg,w_300,c_fit/uploads/da25bfedc80c40dfa8e78afc8e19616b/2ad575e310464a7285b577acf2e0e7af.png" > -->
        ...
        <hr>
        <small v-for="tag in post.tags" :key="tag.id" class="pull-left" style="margin-right: 20px;border-radius: 5px;border: 1px solid gray;padding: 5px;">        
