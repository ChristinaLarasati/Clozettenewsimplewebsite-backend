<template>
    <div class="laravelComment" :id="'laravelComment-' + postid " style="clear: both;padding-top: 20px;">         
         <div class="ui threaded comments" :id="postid+'-comment-0'">
            ...
            <div v-for="comment in comments" :class="'comment show-' + postid + '-0'" :id="'comment-' + comment.id " :key="comment.id">
                 <a class="avatar">
                ...
                <div class="replybox" :id="comment.id + 'reply-box'"></div>
            </div>            
        </div>
        <div v-for="children in comment.children" class="comments" :id="postid + '-comment-' + children.id" :key="children.id">
