...
class TutorialController extends Controller {
    ...
    public function getTutorial($section) {
        return [
            'categories' => category_post::select('categories.name', 'categories.slug', \DB::raw('COUNT(category_posts.category_id) as post_count'))
            ->where ('categories.name', 'like', "%$section%") -> groupBy('category_posts.category_id')
