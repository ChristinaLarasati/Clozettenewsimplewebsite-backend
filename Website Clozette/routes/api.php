...
Route::post('postusers', 'PostUserController@store');
Route::group(['namespace' => 'User', 'guard' => 'api'], function() {
    ...
    Route::group(['middleware' => ['check.ajax']], function() {
        ...
        Route::get('get-category-posts/{tutorials}', 'PostController@postCategoryDetails');
        Route::get('get-tag-posts/{tag}', 'PostController@postTagDetails');
        Route::get('get-post-comments/{id}', 'PostController@postComments');
        
        Route::get('get-all-categories', 'PostController@getAllCategories');
        
        // SideBar Controller
        Route::get('get-sidebar/{section}', 'SidebarController@getSideBar');
        //Tutorrial Controller
        // Route::get('get-tutorial/{section}', 'TutorialsController@getTutorials');
        // Archive Controller
