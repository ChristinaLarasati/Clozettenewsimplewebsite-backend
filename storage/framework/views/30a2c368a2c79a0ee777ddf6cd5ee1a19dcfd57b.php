            ...
            <div class="box-body">
              ...
              <br/>
                ...
                <!-- <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="subtitle" name="subtitle" placeholder="Sub Title" value="<?php echo e(old('subtitle')); ?>">
                </div> -->

                <div class="form-group">
                  <label for="slug">Sub Title</label>
                  <input type="text" class="form-control" id="slug" name="slug" placeholder="Sub Title" value="<?php echo e(old('slug')); ?>">
                </div>
                            ...
                            <br>
                              <div class="form-group">
                                ...
                                <div class="checkbox pull-left">
                                  <label>
                                    <input type="checkbox" name="status" value="1" <?php if(old('status')): ?> <?php echo e("checked='checked'"); ?> <?php endif; ?>> Publish
                                  </label>
                                </div>
                              </div>
                              <br>
                              <div class="form-group" style="margin-top:18px;">
                                ...
                                <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option <?php if(!empty(old('tags')) && in_array($tag->id, old('tags'))): ?> <?php echo e('selected="selected"'); ?> <?php endif; ?> value="<?php echo e($tag->id); ?>"><?php echo e($tag->name); ?></option>
                              ...
                              <div class="form-group" style="margin-top:18px;">
                                ...
                                <select class="form-control select2 select2-hidden-accessible" multiple="" data-placeholder="Select a State" style="width: 100%;" tabindex="-1" aria-hidden="true" name="categories[]">
                                  <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option <?php if(!empty(old('categories')) && in_array($category->id, old('categories'))): ?> <?php echo e('selected="selected"'); ?> <?php endif; ?> value="<?php echo e($category->id); ?>"><?php echo e($category->name); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                              </div>
